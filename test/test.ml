  ...
  [%expect
    ...
    (Event
     ((timestamp 358ns) (thread 1) (category 107) (name 105) (arguments ())
      (event_type Duration_end)))
    (Error No_more_words)
    Warning, unexpected case reached [src/trace_segment.ml:670:7]: ("return [dst] does not match known trace state."(dst 0x38df7fb74073))
    |}];
  return ()
;;
  ...
  [%expect
    ...
    (Event
     ((timestamp 628ns) (thread 1) (category 107) (name 105) (arguments ())
      (event_type Duration_end)))
    (Error No_more_words)
    Warning, unexpected case reached [src/trace_segment.ml:670:7]: ("return [dst] does not match known trace state."(dst 0xeab2ebcd97d))
    Warning, unexpected case reached [src/trace_segment.ml:670:7]: ("return [dst] does not match known trace state."(dst 0x6bd56981ff1e))
    Warning, unexpected case reached [src/trace_segment.ml:670:7]: ("return [dst] does not match known trace state."(dst 0x3218dd4125e6))
    Warning, unexpected case reached [src/trace_segment.ml:670:7]: ("return [dst] does not match known trace state."(dst 0x7484e5a78107))
    |}];
  return ()
;;
  ...
  [%expect
    ...
    (Event
     ((timestamp 3ns) (thread 1) (category 107) (name 105) (arguments ())
      (event_type Duration_end)))
    (Error No_more_words)
    Warning, unexpected case reached [src/trace_segment.ml:564:6]: ("call [src] does not match known trace state."(src 0x0))
    |}];
  return ()
;;
  ...
  [%expect
    ...
    (Event
     ((timestamp 12ns) (thread 1) (category 107) (name 105) (arguments ())
      (event_type Duration_end)))
    (Error No_more_words)
    Warning, unexpected case reached [src/trace_segment.ml:670:7]: ("return [dst] does not match known trace state."(dst 0x0))
    |}];
  return ()
;;
